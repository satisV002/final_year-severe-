...
router.get('/groundwater', validate_1.validateQueryParams, (0, catchAsync_1.catchAsync)(async (req, res) => {
    const { state, district, village, pinCode, stationName, fromDate, toDate, page = '1', limit = '20', sort = 'date:-1', } = req.query;
    const query = {};
...
router.get('/pincodes/suggest', (0, catchAsync_1.catchAsync)(async (req, res) => {
...
// POST /api/v1/sync
router.post('/sync', (0, catchAsync_1.catchAsync)(async (req, res) => {
