...
let allStations = [];
try {
    const stationsPath = path_1.default.join(__dirname, '../data/stations.json');
    const data = fs_1.default.readFileSync(stationsPath, 'utf8');
...
router.get('/groundwater', (0, catchAsync_1.catchAsync)(async (req, res) => {
    ...
    const l = Math.min(parseInt(limit, 10) || 100, 2000);
