...
// GET /api/stations
router.get('/stations', catchAsync(async (req, res) => {
...
router.get('/station/:stationId', catchAsync(async (req, res) => {
...
router.get('/rainfall/station/:stationId', catchAsync(async (req, res) => {
    const stationId = req.params.stationId as string;
...
router.get('/live-groundwater/:stationId', catchAsync(async (req, res) => {
    const stationId = req.params.stationId as string;
...
router.get('/analysis/:stationId', catchAsync(async (req, res) => {
    const stationId = req.params.stationId as string;
